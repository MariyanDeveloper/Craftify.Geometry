...
using Craftify.Geometry.Functional;
using static Craftify.Geometry.Functional.F;
namespace Craftify.Geometry.Extraction;


public class GeometryExtractionConfig
{
    public static readonly GeometryExtractionConfig Default = new GeometryExtractionConfig();
